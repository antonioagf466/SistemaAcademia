...
namespace SistemaAcademia.Controllers
{
    public class SalasController : Controller
    {
        ...
        public SalasController(SistemaAcademiaContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Sala != null ? 
                          ...
                          Problem("Entity set 'SistemaAcademiaContext.Sala'  is null.");
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Nome,Tipo")] Sala sala)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nome,Tipo")] Sala sala)
        {
            if (id != sala.Id)
            {
                return NotFound();
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'SistemaAcademiaContext.Sala'  is null.");
            }
            var sala = await _context.Sala.FindAsync(id);
            if (sala != null)
            {
