...
namespace SistemaAcademia.Controllers
{
    public class ProfessoresController : Controller
    {
        ...
        public ProfessoresController(SistemaAcademiaContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Professor != null ? 
                          ...
                          Problem("Entity set 'SistemaAcademiaContext.Professor'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'SistemaAcademiaContext.Professor'  is null.");
            }
            var professor = await _context.Professor.FindAsync(id);
            if (professor != null)
            {
